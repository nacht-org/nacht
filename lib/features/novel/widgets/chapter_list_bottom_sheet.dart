...
class ChapterListBottomSheet extends ConsumerWidget {
  const ChapterListBottomSheet({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Consumer(
                builder: (context, ref, child) {
                  final sort = ref.watch(chapterListPreferencesProvider
                      .select((pref) => pref.sort));
            ...
            Padding(
              ...
              child: Consumer(
                builder: (context, ref, child) {
                  final order = ref.watch(chapterListPreferencesProvider
                      .select((pref) => pref.order));

                  return Wrap(
                    spacing: 8.0,
                    runSpacing: 4.0,
                    children:
                        List.generate(OrderPreference.values.length, (index) {
