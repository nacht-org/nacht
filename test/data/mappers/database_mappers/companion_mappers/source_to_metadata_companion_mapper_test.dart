...
import 'package:chapturn/data/mappers/database_mappers/companion_mappers/source_to_metadata_companion_mapper.dart';
  ...
  mapperGroup(
    ...
    test: (mapper) {
      mapperTest(
        ...
        stub: () {
          when(mockNamespaceMapper.map(sources.Namespace.dc))
