...
class MockParseNovel extends _i1.Mock implements _i3.ParseNovel {
  ...
  @override
  _i4.Future<_i2.Novel> fetchNovel(String? url) => (super.noSuchMethod(
        Invocation.method(
          #fetchNovel,
          [url],
        ),
  ...
  @override
  _i4.Future<String?> fetchChapterContent(String? url) => (super.noSuchMethod(
        Invocation.method(
          #fetchChapterContent,
          [url],
        ),
  ...
  @override
  _i4.Future<List<_i2.Novel>> search(
    String? query,
    int? page,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  String buildPopularUrl(int? page) => (super.noSuchMethod(
        Invocation.method(
          #buildPopularUrl,
          [page],
        ),
  ...
  @override
  _i4.Future<List<_i2.Novel>> fetchPopular(int? page) => (super.noSuchMethod(
        Invocation.method(
          #fetchPopular,
          [page],
        ),
